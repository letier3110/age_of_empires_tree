/*! svg.js v2.6.4 MIT*/ !(function (t, e) {
      ...
      ;(this.r = 0),
        ...
        t &&
          ('string' == typeof t
            ...
            : 'object' == typeof t && ((this.r = t.r), (this.g = t.g), (this.b = t.b)))
    }),
    w.extend(w.Color, {
      toString: function () {
        return this.toHex()
    ...
    w.extend(w.Array, {
      ...
      settle: function () {
        for (var t = 0, e = this.value.length, i = []; t < e; t++)
          i.indexOf(this.value[t]) == -1 && i.push(this.value[t])
        return (this.value = i)
      },
      at: function (t) {
  ...
  for (
    ...
    b[C[N]] = (function (t) {
      return function (e, i, n) {
        ...
        else for (var r = 0, s = e.length; r < s; ++r) e[r] = e[r] + (r % 2 ? i.y : i.x)
        return b[t](e, i, n)
      }
    })(C[N].toUpperCase())
  ;(w.PathArray = function (t, e) {
    ...
    w.extend(w.PathArray, {
            ...
            (n = this.value[r][0]),
              'M' == n || 'L' == n || 'T' == n
                ...
                ? ((this.value[r][1] += t),
                  ...
                  (this.value[r][3] += t),
                  (this.value[r][4] += e),
                  'C' == n && ((this.value[r][5] += t), (this.value[r][6] += e)))
                : 'A' == n && ((this.value[r][6] += t), (this.value[r][7] += e))
        return this
      },
      size: function (t, e) {
        var i,
        ...
        for (i = this.value.length - 1; i >= 0; i--)
          (n = this.value[i][0]),
            'M' == n || 'L' == n || 'T' == n
              ? ((this.value[i][1] = ((this.value[i][1] - r.x) * t) / r.width + r.x),
              ...
              ? ((this.value[i][1] = ((this.value[i][1] - r.x) * t) / r.width + r.x),
                ...
                'C' == n &&
                  ((this.value[i][5] = ((this.value[i][5] - r.x) * t) / r.width + r.x),
                  (this.value[i][6] = ((this.value[i][6] - r.y) * e) / r.height + r.y)))
              : 'A' == n &&
      ...
      equalCommands: function (t) {
        var e, i, n
        for (
          t = new w.PathArray(t), n = this.value.length === t.value.length, e = 0, i = this.value.length;
          n && e < i;
          e++
        )
      ...
      morph: function (t) {
        return (
          (t = new w.PathArray(t)), this.equalCommands(t) ? (this.destination = t) : (this.destination = null), this
        )
      },
      at: function (t) {
        if (!this.destination) return this
      ...
      parse: function (t) {
        ...
        var n = [],
          ...
          h = t.length
        do
          w.regex.isPathLetter.test(t[a]) ? ((e = t[a]), ++a) : 'M' == e ? (e = 'L') : 'm' == e && (e = 'l'),
          ...
          'number' == typeof t
            ...
            ? ((e = t.match(w.regex.numberAndUnit)),
              e &&
                ...
                (this.unit = e[5])))
            : t instanceof w.Number && ((this.value = t.valueOf()), (this.unit = t.unit))
      },
      extend: {
        toString: function () {
          return (
    ...
    (w.FX = w.invent({
      ...
      extend: {
        ...
        queue: function (t) {
          return (
            ('function' == typeof t || t instanceof w.Situation) && this.situations.push(t),
        ...
        atEnd: function () {
          return (
            this.situation.loops === !0 && (this.situation.loops = this.situation.loop + 1),
        ...
        step: function (t) {
          if ((t || (this.absPos = this.timeToAbsPos(+new Date())), this.situation.loops !== !1)) {
            ...
            ;(e = Math.max(this.absPos, 0)),
              (i = Math.floor(e)),
              this.situation.loops === !0 || i < this.situation.loops
                ? ((this.pos = e - i), (n = this.situation.loop), (this.situation.loop = i))
          ...
          for (var s in this.situation.once)
            s > this.lastPos &&
              s <= r &&
              (this.situation.once[s].call(this.target(), this.pos, r), delete this.situation.once[s])
          return (
            this.active &&
              this.target().fire('during', { pos: this.pos, eased: r, fx: this, situation: this.situation }),
            this.situation
              ? (this.eachAt(),
          ...
          if (s.transforms.length) {
            for (i = s.initialTransformation, t = 0, e = s.transforms.length; t < e; t++) {
              ...
              o instanceof w.Matrix
                ...
                : (o.relative || o.undo(i.extract()), (i = i.multiply(o.at(s.ease(this.pos)))))
            }
            r.matrix(i)
          }
          return this
    ...
    (w.Box = w.invent({
      create: function (t, e, i, n) {
        return 'object' != typeof t || t instanceof w.Element
          ? (4 == arguments.length && ((this.x = t), (this.y = e), (this.width = i), (this.height = n)), void y(this))
          : w.Box.call(this, null != t.left ? t.left : t.x, null != t.top ? t.top : t.y, t.width, t.height)
      },
      extend: {
        merge: function (t) {
        ...
        if ((w.Box.apply(this, [].slice.call(arguments)), t instanceof w.Element)) {
          ...
          try {
            ...
            if (t instanceof w.Shape) {
              ...
              i = { x: t.node.clientLeft, y: t.node.clientTop, width: t.node.clientWidth, height: t.node.clientHeight }
          }
          w.Box.call(this, i)
        }
      },
    ...
    w.extend(w.Element, {
      transform: function (t, e) {
        ...
        if (((i = new w.Matrix(r)), (e = !!e || !!t.relative), null != t.a))
          ...
          p(t, r), (i = e ? i.rotate(t.rotation, t.cx, t.cy) : i.rotate(t.rotation - i.extract().rotation, t.cx, t.cy))
          ...
          t.flip
            ? ('x' == t.flip || 'y' == t.flip
                ? (t.offset = null == t.offset ? r.bbox()['c' + t.flip] : t.offset)
                : null == t.offset
                ? ((n = r.bbox()), (t.flip = n.cx), (t.offset = n.cy))
                : (t.flip = t.offset),
              (i = new w.Matrix().flip(t.flip, t.offset)))
            : (null == t.x && null == t.y) ||
              (e ? (i = i.translate(t.x, t.y)) : (null != t.x && (i.e = t.x), null != t.y && (i.f = t.y)))
      ...
      transform: function (t, e) {
        ...
        return 'object' != typeof t
          ...
          : ((e = !!e || !!t.relative),
            ...
            i ? ((i.relative = e), this.last().transforms.push(i), this._callStart()) : this)
      },
    }),
    w.extend(w.Element, {
    ...
    (w.Transformation = w.invent({
      create: function (t, e) {
        ...
        if (Array.isArray(t)) for (var i = 0, n = this.arguments.length; i < n; ++i) this[this.arguments[i]] = t[i]
      ...
      extend: {
        ...
        at: function (t) {
          ...
          return (
            (r = new w.Matrix().morph(w.Matrix.prototype[this.method].apply(r, e)).at(t)),
      ...
      extend: {
        ...
        at: function (t) {
          var e = new w.Matrix().rotate(
            new w.Number().morph(this.rotation - (this._undo ? this._undo.rotation : 0)).at(t),
            this.cx,
            this.cy
          )
      ...
      extend: {
        ...
        each: function (t, e) {
          ...
          for (i = 0, n = r.length; i < n; i++)
            r[i] instanceof w.Element && t.apply(r[i], [i, r]), e && r[i] instanceof w.Container && r[i].each(t, e)
          return this
        },
      ...
      create: function (t) {
        ...
        if (t instanceof w.Element) {
          for (
            ...
            (l *= n.value),
              (n = new w.Number(a instanceof w.Doc ? a.parent().offsetWidth : a.parent().width())),
              (a = a.parent())
          for (; '%' == r.unit; )
            (c *= r.value),
              (r = new w.Number(h instanceof w.Doc ? h.parent().offsetHeight : h.parent().height())),
              (h = h.parent())
          ;(this.x = 0),
            (this.y = 0),
            (this.width = n * l),
    ...
    (w.off = function (t, e, i) {
      ...
      if (n != -1)
        if (i) {
          ...
          w.listeners[n][r] &&
            w.listeners[n][r][s || '*'] &&
            (t.removeEventListener(r, w.listeners[n][r][s || '*'][i], !1), delete w.listeners[n][r][s || '*'][i])
        } else if (s && r) {
          if (w.listeners[n][r] && w.listeners[n][r][s]) {
            for (i in w.listeners[n][r][s]) w.off(t, [r, s].join('.'), i)
            delete w.listeners[n][r][s]
          }
        } else if (s) for (e in w.listeners[n]) for (o in w.listeners[n][e]) s === o && w.off(t, [e, s].join('.'))
        else if (r) {
          if (w.listeners[n][r]) {
      ...
      fire: function (e, i) {
        return (
          e instanceof t.Event
            ...
            : this.node.dispatchEvent((e = new t.CustomEvent(e, { detail: i, cancelable: !0 }))),
          (this._event = e),
          this
        )
      },
    ...
    w.extend(w.Element, {
      clipWith: function (t) {
        return (
          (this.clipper = t instanceof w.ClipPath ? t : this.parent().clip().add(t)),
    ...
    (w.Doc = w.invent({
      create: function (t) {
        t &&
          ...
          'svg' == t.nodeName
            ? this.constructor.call(this, t)
            : (this.constructor.call(this, w.create('svg')), t.appendChild(this.node), this.size('100%', '100%')),
          this.namespace().defs())
      },
      inherit: w.Container,
      extend: {
    ...
    (w.Line = w.invent({
      ...
      extend: {
        ...
        plot: function (t, e, i, n) {
          return null == t
            ? this.array()
            : ((t = 'undefined' != typeof e ? { x1: t, y1: e, x2: i, y2: n } : new w.PointArray(t).toLine()),
              this.attr(t))
        },
        move: function (t, e) {
    ...
    w.extend(w.Polyline, w.Polygon, {
      ...
      plot: function (t) {
        return null == t
          ? this.array()
          : this.clear().attr('points', 'string' == typeof t ? t : (this._array = new w.PointArray(t)))
      },
      clear: function () {
    ...
    (w.Path = w.invent({
      ...
      extend: {
        ...
        plot: function (t) {
          return null == t
            ? this.array()
            : this.clear().attr('d', 'string' == typeof t ? t : (this._array = new w.PathArray(t)))
        },
        clear: function () {
          return delete this._array, this
        },
            ...
            w.on(n, 'load', function () {
              ...
              null !== t &&
                ...
                'function' == typeof i._loaded &&
                  i._loaded.call(i, { width: n.width, height: n.height, ratio: n.width / n.height, url: e }))
            }),
  ...
  ;['fill', 'stroke'].forEach(function (t) {
    ...
    w.extend(w.Element, {
      remember: function (t, e) {
        if ('object' == typeof arguments[0]) for (var e in t) this.remember(e, t[e])
        else {
